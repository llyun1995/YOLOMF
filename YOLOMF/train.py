...
from nets.yolo_loss import (YOLOLoss, get_lr_scheduler, set_optimizer_lr, weights_init)
...
if __name__ == "__main__":
   ...
   # model = YoloBody(anchors_mask, num_classes, phi_0=phi_0, phi_1=phi_1, phi_2=phi_2,  backbone = backbone, pretrained = pretrained)
    if not pretrained:
        weights_init(model)
    if model_path != '':
        #------------------------------------------------------#
